...
##### Useful #####
PRECISION: int = 2  # Number of shot per degree (More than 5 isn't useful)
MAX_BOUNCES: int = 5  # Number of bounces allowed for a shot
MIN_WALL_SURFACE: int = 1000  # Minimal wall surface allowed

T_SIZE: int = 25  # Target's size
S_SIZE: int = 25  # Shooter's size

WIDTH: int = 1000  # Space width
HEIGHT: int = 700  # Space height

##### Cosmetic (colors) #####
TITLE: str = "Shot n' Ricochet Simulator 2D"  # Window's title
L_COLOR: str = "#FF7F00"  # Shot line's color
FASTEST_COLOR: str = "#0000FF"
